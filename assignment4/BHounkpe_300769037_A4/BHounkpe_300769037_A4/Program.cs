...
namespace BHounkpe_300769037_A3_Part2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Best time for SCM 1500  free for swimmer 3 is: {0}", swimmer3.GetBestTime(PoolType.SCM, Stroke.Freestyle, EventDistance._1500).ToString(@"mm\:ss\.ff"));
